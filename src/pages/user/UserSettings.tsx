                ...
                <section className="bg-white dark:bg-neutral-800 rounded-3xl p-6 border border-neutral-100 dark:border-neutral-700 shadow-sm">
                    ...
                    <div className="flex items-center justify-between p-4 rounded-2xl bg-neutral-50 dark:bg-neutral-900/50">
                        <div>
                            ...
                            <p className="text-sm text-neutral-500 dark:text-neutral-400">Reduce glare and improve night-time viewing</p>
                        </div>
                        <button
                            onClick={toggleTheme}
                            className={`w-14 h-8 rounded-full p-1 transition-colors duration-300 ${theme === 'dark' ? 'bg-red-500' : 'bg-neutral-300'}`}
                        >
